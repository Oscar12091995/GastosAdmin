...
export class MarcasService {
  ...
  listMarcas(page = 1, search: string = '') {
    ...
    let URL = URL_SERVICIOS + "/marcas?page=" + page + "&search=" + search;
  ...
  updateMarca(ID_MARCA: string, data: any) {
    //apartado necesario de metronic
    //inicio de solicitud http
    this.isLoadingSubject.next(true);
    //para acceder al token y enviarlo en la apeticion http
    ...
    let URL = URL_SERVICIOS + "/marcas/" + ID_MARCA;
